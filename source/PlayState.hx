...
class PlayState extends MusicBeatState
{
	...
	public static var storyPlaylist:Array<String> = [masturbasuceso];
...
//			remove(bg);
	...
	override public function update(elapsed:Float)
	{
		...
		if(ratingName == '?') {
			...
			scoreTxt.text = 'Score: ' + songScore + ' | Port by Guislakkkk | Misses: ' + songMisses + ' | Rating: ' + ratingName + ' (' + Highscore.floorDecimal(ratingPercent * 100, 2) + '%)' + ' - ' + ratingFC;//peeps wanted no integer rating
		}
